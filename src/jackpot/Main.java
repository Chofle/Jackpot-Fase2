...
public class Main extends javax.swing.JFrame {
    ArrayList<Jackpot> jackpotsList;
    private final String XML_FILE_NAME = "jackpot_record";
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if (respuesta == JOptionPane.OK_OPTION) {
            ...
            JackpotXMLParser.createXML(jackpotsList,XML_FILE_NAME);
            this.dispose();
        } else {
            //Aquí lo que haya que ejecutar al cancelar el cierre de la ventana
            JackpotXMLParser.createXMLEstandar(jackpotsList);
        }
